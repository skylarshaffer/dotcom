    ...
    >
      <div className="md:col-span-3 bg-primary">
        ...
        >
          ...
          <span className="h-8"><svg className="w-[inherit] h-[inherit]" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048"><defs></defs><title>flat</title><path className="cls-1" fill="#009fe0" d="M1462.86,1024c0,404-327.47,731.43-731.43,731.43S0,1428,0,1024H731.43V292.57C1135.39,292.57,1462.86,620,1462.86,1024Z"/><polygon className="cls-2" fill="#ffe001" points="731.43 1024 1462.86 1024 2048 1609.14 2048 1755.42 731.43 1755.43 731.43 1024"/><path className="cls-3" fill="#f7bcda" d="M731.43,292.57V1024C327.47,1024,0,696.53,0,292.57Z"/></svg></span>
