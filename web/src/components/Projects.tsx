  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 mx-auto sm:px-6 lg:px-8 lg:py-14">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bd-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
          ...
          <div className="p-4 md:p-6">
            ...
            A suite of tools, databases, and data analytics for BrickLink sellers.
          </div>
